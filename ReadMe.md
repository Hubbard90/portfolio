...
Both models produced two distinct clusters of customer segments that are different in terms of volume and product mix. For the k-means model, cluster KM_0 represents low to moderate spenders who have lower spending on average across all categories, especially for detergents paper and delicatessen. KM_1 has a significantly higher spending across all categories, especially for milk and detergents paper, indicating that these might be institutional or wholesale buyers like hotels and cafes while KM_1 shows signs of customers buying for their own households. The clustering reinforces the patterns of the k-means model but with sharper contrasts. HC_0 resembles KM_0 since it has modest spending, while HC_1 has higher averages, with the same highest averages as KM_1, which is milk and delicatessen. Because the differences are more pronounced here, this further reinforces that cluster 0 for both consists of household spending, and cluster 1 consists of institutional spending. The higher silhouette score of the hierarchical clustering model further shows that this model gives better distinction between the two clusters:  
